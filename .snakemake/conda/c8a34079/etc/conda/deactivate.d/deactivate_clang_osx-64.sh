...
if [ "${CONDA_BUILD:-0}" = "1" ]; then
  ...
  CPPFLAGS_USED="-D_FORTIFY_SOURCE=2 -mmacosx-version-min=10.9 -isystem ${PREFIX}/include"
  ...
  CPPFLAGS_USED="-D_FORTIFY_SOURCE=2 -mmacosx-version-min=10.9 -isystem ${CONDA_PREFIX}/include"
